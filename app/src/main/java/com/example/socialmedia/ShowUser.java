...
public class ShowUser extends AppCompatActivity {
    ...
    private void sendNotification(String userid,String name_result,String key){

        databaseReference dbr = new databaseReference();
        FirebaseDatabase.getInstance(dbr.keyDb()).getReference().child(userid).child("token").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
